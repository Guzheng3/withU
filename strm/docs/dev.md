...
### 克隆项目
```bash
git clone https://github.com/Guzheng3/ostrm.git
cd ostrm
```
...
### 获取帮助
- 查看 [项目文档](https://github.com/Guzheng3/ostrm/blob/main/README.md)
- 在 [GitHub Discussions](https://github.com/Guzheng3/ostrm/discussions) 中讨论
- 在 [GitHub Issues](https://github.com/Guzheng3/ostrm/issues) 中报告问题
...
### 行为准则
请阅读并遵守项目的 [行为准则](https://github.com/Guzheng3/ostrm/blob/main/CODE_OF_CONDUCT)。
