  ...
  <div class="min-h-screen flex items-center justify-center py-12 px-4">
    <div class="max-w-md w-full space-y-8">
      ...
      <div v-if="checkingUser" class="text-center">
        ...
        <p class="text-sm text-gray-500">正在检查账户状态...</p>
      </div>
      ...
      <div v-else-if="!showRegister" class="animate-fade-in">
        ...
        <div class="text-center mb-8">
          ...
          <p class="text-gray-500">登录到您的 withUstrm 账户</p>
        </div>
          ...
          <form @submit.prevent="handleLogin" class="space-y-5">
            ...
            <div class="flex items-center justify-between">
              <div class="flex items-center">
                ...
                <label for="remember-me" class="ml-2 block text-sm text-gray-500">记住我</label>
              </div>
            </div>
      ...
      <div v-else class="animate-fade-in">
        <div class="text-center mb-8">
          <div class="w-16 h-16 bg-gradient-to-br from-green-400 to-pink-400 rounded-2xl flex items-center justify-center mx-auto mb-5 shadow-lg shadow-emerald-900/20">
            <svg class="w-9 h-9 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
              <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M18 9v3m0 0v3m0-3h3m-3 0h-3m-2-5a4 4 0 11-8 0 4 4 0 018 0zM3 20a6 6 0 0112 0v1H3v-1z"></path>
            </svg>
          </div>
          <h2 class="text-3xl font-bold gradient-text mb-2">创建账户</h2>
          <p class="text-gray-500">用户不存在，请先注册</p>
        </div>
        ...
        <div class="card">
          <form @submit.prevent="handleRegister" class="space-y-5">
            <div class="space-y-4">
              <div>
                <label for="reg-username" class="block text-sm font-medium text-gray-600 mb-2">用户名</label>
              ...
              <div>
                <label for="reg-password" class="block text-sm font-medium text-gray-600 mb-2">密码</label>
              ...
              <div>
                <label for="reg-confirm-password" class="block text-sm font-medium text-gray-600 mb-2">确认密码</label>
            ...
            <div v-if="userExists" class="text-center">
              <button type="button" @click="showRegister = false; clearForms()" class="text-sm text-gray-500 hover:text-gray-700 transition-colors">
                返回登录
              </button>
            </div>
          </form>
