...
<!-- 情侣头像点击效果已迁移到 lg-components.js 的 AvatarInteraction 模块 -->
    ...
    <title>轨迹 — KKiSS小星球</title>
</head>

<body class="bg-diffuse-glow">
    <div id="pjax-container">
        <!-- 时间轴专用样式 -->
        <link rel="stylesheet" href="/Style/css/timeline.css?wm=4c668768&v=1.0.16">
        <!-- 迷你地图组件（地点卡片） -->
        <link rel="stylesheet" href="/assets/css/lg-mini-map.css?wm=4c668768&v=1.0.16">
        <script src="/assets/js/lg-mini-map.js?wm=4c668768&v=1.0.16"></script>
        ...
        <script>
            ...
            window.TIMELINE_AUTHORS = {};
                ...
                name: "Kasenn",
                avatar: "http:\/\/175.178.43.207\/uploads\/20260727162009_6a6714b9aebf7108096927.webp",
                gender: ""            };
                        window.TIMELINE_AUTHORS[2] = {
                name: "Soyuet",
                avatar: "http:\/\/175.178.43.207\/uploads\/20260727162023_6a6714c777d1b010266032.webp",
                gender: ""            };
                        // 兼容旧数据 male/female 键
                    </script>

        <!-- WaveSurfer 音频波形 -->
        <script src="/Style/js/wavesurfer.min.js?wm=4c668768&v=1.0.16"></script>
        <!-- 时间轴页面 JS -->
        <script src="/assets/js/page-timeline.js?wm=4c668768&v=1.0.16"></script>
...
<script>
    (function () {
        var requestId = "1fe1b41716c1fe2348bf470176b1967b";
        var token = "bdf9ce71bc3be7b8a8a46e2aa2144391e35314b2c7253e34a25b193a5fe88671";
