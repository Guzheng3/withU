...
<head>
    <title>打视频时的小瞬间 — KKiSS小星球</title>
    <meta name="author" content="Ki">
    <meta name="love-theme" content="LGNewUI-情侣小站">
</head>

<body class="bg-diffuse-glow">
    <div id="pjax-container" data-view-target="album" data-view-id="1785164057785">
        <!-- PJAX 浏览量元数据 -->
        <div id="lg-view-meta" data-view-target="album" data-view-id="1785164057785" style="display:none;"></div>
        <link rel="stylesheet" href="/Style/css/photo.css?wm=4c668768&v=1.0.16">
        <link rel="stylesheet" href="/Style/css/lgnewui-detail.css?wm=4c668768&v=1.0.16">

        <!-- 相册头部 -->
                <div class="lgnew-new-photo-head-wrapper">
            <header class="lgnew-new-photo-head-hero-header">
                <img class="lgnew-new-photo-head-hero-img lazy" data-src="http://175.178.43.207/uploads/20260727225412_6a67711442080934557552.webp" alt="打视频时的小瞬间" referrerpolicy="no-referrer">
                <div class="lgnew-new-photo-head-hero-gradient"></div>

                <div class="lgnew-new-photo-head-hero-footer">
                    <!-- 上层：标题 + 描述 -->
                    <div class="lgnew-new-photo-head-title-area">
                        <h1 class="lgnew-new-photo-head-title">打视频时的小瞬间</h1>
                                            </div>

                    <!-- 下层：信息标签栏 -->
                    <div class="lgnew-new-photo-head-info-bar">
                        <div class="lgnew-new-photo-head-info-left">
                            <div class="lgnew-new-photo-head-watermark">
                                <span class="lgnew-new-photo-head-watermark-dot"></span>
                                ALBUM REF. 1785164057785                            </div>
                            <div class="lgnew-new-photo-head-chips-group">
                                <div class="lgnew-new-photo-head-chip">
                                    <div class="lgnew-new-photo-head-chip-icon-bg"><i class="ph ph-eye"></i></div>
                                    <span class="lgnew-new-photo-head-chip-text" data-view-count="album:1785164057785">0</span>
                                </div>
                                <div class="lgnew-new-photo-head-chip" data-like-target="album" data-like-id="1785164057785" style="cursor:pointer;">
                                    <div class="lgnew-new-photo-head-chip-icon-bg"><i class="ph ph-heart"></i></div>
                                    <span class="lgnew-new-photo-head-chip-text lg-interaction-like-num" data-like-count="album:1785164057785">0</span>
                                </div>
                                <div class="lgnew-new-photo-head-chip">
                                                                        <img class="lgnew-new-photo-head-chip-avatar lazy" data-src="http://175.178.43.207/uploads/20260727162023_6a6714c777d1b010266032.webp" alt="Soyuet" referrerpolicy="no-referrer">
                                                                        <span class="lgnew-new-photo-head-chip-text">Soyuet</span>
                                </div>
                                                            </div>
                        </div>

                        <div class="lgnew-new-photo-head-info-right">
                            <div class="lgnew-new-photo-head-chips-group">
                                <div class="lgnew-new-photo-head-chip">
                                    <div class="lgnew-new-photo-head-chip-icon-bg"><i class="ph ph-calendar"></i></div>
                                    <span class="lgnew-new-photo-head-chip-text">2026年5月20日</span>
                                </div>
                                                                <div class="lgnew-new-photo-head-chip">
                                    <div class="lgnew-new-photo-head-chip-icon-bg"><i class="ph ph-clock"></i></div>
                                    <span class="lgnew-new-photo-head-chip-text">2个月前</span>
                                </div>
                                                                <div class="lgnew-new-photo-head-chip" id="imglist-total-count" style="display:none;">
                                    <div class="lgnew-new-photo-head-chip-icon-bg"><i class="ph ph-camera"></i></div>
                                    <span class="lgnew-new-photo-head-chip-text">加载中...</span>
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <!-- 瀑布流容器 -->
        <div class="lgnewui-new-photo">
            <div id="imglist-grid" class="imglist-masonry-grid" data-code="1785164057785" data-album-name="打视频时的小瞬间" data-show-info="true"
        ...
        <aside class="lgnewui-detail-vertical-rail">
            <button class="lgnewui-detail-rail-btn" id="rail-like-btn" data-like-target="album" data-like-id="1785164057785" data-lg-tip="<span data-like-count='album:1785164057785'>0</span> 人喜欢" data-lg-tip-html="true" data-lg-tip-force="true" data-lg-tip-dir="left">
...
<script>
    (function () {
        var requestId = "f6691363650ce87d09fe3b6b9181c811";
        var token = "2dd4692579c347ccadb9c27c634a52498ace0158b675a7d47951640313fc1482";
