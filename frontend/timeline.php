...
<!-- 情侣头像点击效果已迁移到 components.js 的 AvatarInteraction 模块 -->
    ...
    <title>轨迹 — <?php echo htmlspecialchars($withuSiteTitle, ENT_QUOTES, 'UTF-8'); ?></title>
</head>
...
<body class="bg-pdot-vignette">
    <div id="pjax-container">
        ...
        <link rel="stylesheet" href="/assets/css/page-timeline-fa60df2b.css">
...
<script src="/assets/js/page-timeline-cebb6d07.js"></script>
