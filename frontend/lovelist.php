...
<body class="bg-pdot-vignette">
                    ...
                    <div id="list_container">
                        ...
                        <div id="list_data">
                                            ...
                                            <div class="body-info">
                                                ...
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                                                                        <span class="info-value lovelist-location-link has-coords" onclick="event.stopPropagation(); if(window.LGMap) LGMap.open({ mode:'events', coords:[113.820617,22.808944], zoom:15 });" data-tooltip="淘蛙(长安万达店)"><i class="ph-fill ph-map-pin"></i><span>淘蛙(长安万达店)</span></span>
                                                                                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                ...
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                                                                        <span class="info-value lovelist-location-link has-coords" onclick="event.stopPropagation(); if(window.LGMap) LGMap.open({ mode:'events', coords:[110.993509,21.947605], zoom:15 });" data-tooltip="高州市"><i class="ph-fill ph-map-pin"></i><span>高州市</span></span>
                                                                                                    </div>
                                                                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                ...
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                                                                        <span class="info-value lovelist-location-link has-coords" onclick="event.stopPropagation(); if(window.LGMap) LGMap.open({ mode:'events', coords:[113.799025,22.800425], zoom:15 });" data-tooltip="海底捞火锅(长安万科店)"><i class="ph-fill ph-map-pin"></i><span>海底捞火锅(长安万科店)</span></span>
                                                                                                    </div>
                                                                                                    <div class="info-item remark-item">
                                                        <span class="info-label">清单备注 / NOTE</span>
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                ...
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                                                                        <span class="info-value lovelist-location-link has-coords" onclick="event.stopPropagation(); if(window.LGMap) LGMap.open({ mode:'events', coords:[114.695386,23.006932], zoom:15 });" data-tooltip="惠东县"><i class="ph-fill ph-map-pin"></i><span>惠东县</span></span>
                                                                                                    </div>
                                                                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                ...
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                                                                        <span class="info-value lovelist-location-link has-coords" onclick="event.stopPropagation(); if(window.LGMap) LGMap.open({ mode:'events', coords:[114.700042,23.004825], zoom:15 });" data-tooltip="惠东县"><i class="ph-fill ph-map-pin"></i><span>惠东县</span></span>
                                                                                                    </div>
                                                                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                ...
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                                                                        <span class="info-value lovelist-location-link has-coords" onclick="event.stopPropagation(); if(window.LGMap) LGMap.open({ mode:'events', coords:[113.589436,22.284681], zoom:15 });" data-tooltip="珠海日月贝"><i class="ph-fill ph-map-pin"></i><span>珠海日月贝</span></span>
                                                                                                    </div>
                                                                                                    <div class="info-item remark-item">
                                                        <span class="info-label">清单备注 / NOTE</span>
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                ...
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                                                                        <span class="info-value lovelist-location-link has-coords" onclick="event.stopPropagation(); if(window.LGMap) LGMap.open({ mode:'events', coords:[113.890634,22.915318], zoom:15 });" data-tooltip="松山湖风景区"><i class="ph-fill ph-map-pin"></i><span>松山湖风景区</span></span>
                                                                                                    </div>
                                                                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot com"></span>
                                            <span class="event-name">LGNewUi 冬至限定 多图约定测试</span>
                                            <span class="event-tags">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">LGNewUi 冬至限定 多图约定测试</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
    ...
    <script>
        ...
        window.LG_CONFIG.anonymousAvatar = "/Lovefolder/20250310095643_67ce46dbe2e56.webp";
    </script>
...
<script>
    (function () {
        var requestId = "a735c7766aa97da5e9e4543f2b6678c5";
        var token = "17cd69dffe85376be358940d09dd45fcef38866a38a35b3abb9fe7ed8862133d";
