...
<title>页面已加密 — LG-NewUi Demo</title>
<link rel="stylesheet" href="/Style/css/lgnewui-private.css">
<style>
/* 关键内联样式：防止 PJAX 切换时 CSS 未加载导致的无样式闪烁 */
.lgnewui-private-wrapper{position:fixed;top:0;left:0;width:100%;height:100vh;display:flex;align-items:center;justify-content:center;overflow:hidden;z-index:9999;background:#0f172a}
.lgnewui-private-wrapper .lgnewui-private-main-card{position:relative;z-index:10;width:100%;max-width:360px;padding:2.5rem;border-radius:1.5rem;background:rgba(255,255,255,.55);backdrop-filter:blur(20px);-webkit-backdrop-filter:blur(20px);border:1px solid rgba(255,255,255,.5);box-shadow:0 20px 40px -10px rgba(0,0,0,.1);opacity:0;transform:translateY(30px)}
.lgnewui-private-wrapper .lgnewui-private-bg{position:absolute;top:0;right:0;bottom:0;left:0;z-index:0}
.lgnewui-private-wrapper .lgnewui-private-bg-img{width:100%;height:100%;object-fit:cover;opacity:.85;filter:blur(3px)}
.lgnewui-private-wrapper .lgnewui-private-bg-overlay{position:absolute;top:0;right:0;bottom:0;left:0;background:linear-gradient(to bottom,rgba(0,0,0,.1),rgba(0,0,0,.05),rgba(0,0,0,.3))}
html.lgnewui-private-mode body{overflow:hidden}
html.lgnewui-private-mode .row.central.nav_k,html.lgnewui-private-mode #homePage,html.lgnewui-private-mode .footer-warp,html.lgnewui-private-mode #footer-animal,html.lgnewui-private-mode .div_marb_7rem-none,html.lgnewui-private-mode .lgnewui-mobile-nav-root,html.lgnewui-private-mode #NavBtnList,html.lgnewui-private-mode #isAdminIcon,html.lgnewui-private-mode #lgnewuiFloatingActions,html.lgnewui-private-mode .message_btn,html.lgnewui-private-mode #scrollTopBtn,html.lgnewui-private-mode .bg-wrap,html.lgnewui-private-mode #loader-wrapper,html.lgnewui-private-mode .Width_limit_10re{display:none!important}
</style>
<script>document.documentElement.classList.add("lgnewui-private-mode");</script>
<div class="lgnewui-private-wrapper" id="lgnewuiPrivateWrapper">

    <!-- 背景区域 -->
    <div class="lgnewui-private-bg">
                <img id="privateBgImage"
            src="/Lovefolder/20250310100354_67ce488abed5b.webp"
            class="lgnewui-private-bg-img" draggable="false" alt="Background">
                <div id="privateBgOverlay" class="lgnewui-private-bg-overlay"></div>
    </div>

    <!-- 微信小程序风格浮动按钮 -->
    <div class="lgnewui-private-capsule" id="privateCapsule">
                <a href="/" class="lgnewui-private-capsule-btn" title="返回" data-pjax>
            <i data-lucide="chevron-left"></i>
        </a>
        <span class="lgnewui-private-capsule-divider"></span>
        <a href="index.php" class="lgnewui-private-capsule-btn" title="首页" data-pjax>
            <i data-lucide="home"></i>
        </a>
    </div>

    <!-- 主卡片区域 -->
    <div id="privateMainCard" class="lgnewui-private-main-card fade-in-up">

        <!-- 头部信息 -->
        <div class="lgnewui-private-header">
            <div class="lgnewui-private-icon-box">
                <i data-lucide="lock"></i>
            </div>
            <div class="lgnewui-private-badge-container">
                <span class="lgnewui-private-badge">恋爱相册</span>
            </div>
            <h1 class="lgnewui-private-title">LG-NewUi Demo</h1>
            <p class="lgnewui-private-subtitle">
                <span class="lgnewui-private-divider-left"></span>
                <span>相伴的第<span class="lgnewui-private-highlight">1,115</span>天</span>
                <span class="lgnewui-private-divider-right"></span>
            </p>
        </div>

        <!-- 密码表单 -->
        <form id="privateAccessForm" class="lgnewui-private-form" autocomplete="off" onsubmit="return false">
            <div class="lgnewui-private-input-wrapper">
                <i data-lucide="key" class="lgnewui-private-input-icon"></i>
                <input type="password" id="privateAccessCode" name="pagepwd" placeholder="输入暗号"
                    class="lgnewui-private-input" autocomplete="off" data-1p-ignore="true" data-lpignore="true" data-form-type="other" required>
                <button type="button" class="lgnewui-private-eye-btn" id="privateTogglePassword">
                    <i data-lucide="eye" class="lgnewui-private-eye-icon"></i>
                </button>
            </div>

            <button type="submit" id="privateSubmitBtn" class="lgnewui-private-btn">
                <span class="lgnewui-private-btn-text">解锁时光</span>
        ...
        <!-- 底部头像区域 -->
                <div class="lgnewui-private-avatars">
                        <div class="lgnewui-private-avatar-item" title="Ki.">
                <div class="lgnewui-private-avatar-img-box">
                    <img src="/Lovefolder/20260411043037_69d95ded97293201118237.webp"
                        draggable="false" alt="Ki.">
                </div>
            </div>
            
            <div class="lgnewui-private-heart">
                <span class="lgnewui-private-glow-dot"></span>
            </div>

                        <div class="lgnewui-private-avatar-item" title="Really">
                <div class="lgnewui-private-avatar-img-box">
                    <img src="/Lovefolder/20260411043046_69d95df639c33274072975.webp"
...
<script src="/assets/js/lgnewui-private.js"></script>
<script>
