...
public class TaskConfigService {
  ...
  /**
   * 查询引用指定 OpenList 配置的任务
   *
   * @param openlistConfigId OpenList配置ID
   * @return 任务配置列表
   */
  public List<TaskConfig> getByOpenlistConfigId(Long openlistConfigId) {
    return taskConfigMapper.selectByOpenlistConfigId(openlistConfigId);
  }
