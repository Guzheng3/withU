    ...
    <section class="admin-grid" style="margin-bottom:0.75rem;">
        ...
        <div class="admin-card">
            ...
            <form method="POST" novalidate>
                ...
                <div class="form-group" style="margin-bottom:1rem;display:grid;grid-template-columns:2fr 1fr 1fr;gap:.75rem;"><input name="location_name" placeholder="相册地点" value="<?php echo e($album['location_name'] ?? ''); ?>" style="padding:.55rem"><input type="number" step="any" name="latitude" placeholder="纬度" value="<?php echo e($album['latitude'] ?? ''); ?>" style="padding:.55rem"><input type="number" step="any" name="longitude" placeholder="经度" value="<?php echo e($album['longitude'] ?? ''); ?>" style="padding:.55rem"></div>
                <?php if ($isOwner): ?>
                    <div class="form-group" style="margin-bottom:1rem;">
                        <label class="switch">
                            <input
