...
.withu-header-actions .media-search-wrap{flex:0 0 auto;width:auto;min-width:min(250px,42vw)}
</style>
</head>
<body>
<?php
...
<main class="player-shell">
  <div class="player-top"><div class="player-actions"><button id="togetherExit" class="btn btn-secondary" type="button" hidden title="退出一起看" aria-label="退出一起看">一起看</button></div></div>
