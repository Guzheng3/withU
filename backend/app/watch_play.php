...
if ($strmMode) {
    ...
    $strmJwt = withu_strm_internal_token();
    if ($strmJwt === '') { header('Location: /watch.php'); exit; }
    $strmCh = curl_init(withu_strm_backend_base() . '/api/media-library/' . $strmMediaId);
    ...
    $strmRecommendations = [];
    $strmCh2 = curl_init(withu_strm_backend_base() . '/api/media-library?page=1&size=50');
