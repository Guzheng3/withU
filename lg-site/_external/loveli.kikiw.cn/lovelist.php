...
<body class="bg-diffuse-glow">
    <div id="pjax-container">
        <link rel="stylesheet" href="/Style/LoveListStyle/styleCarousel.css?wm=4c668768&v=1.0.16" />
        <style>
            /* --- 样式保持：简约清新风 --- */
            :root {
                --main-accent: #71b7ff;
            ...
            /* 高亮效果（从首页跳转过来时）- 流光边框 */
            .love-card.lgnewui-highlight {
                position: relative;
                overflow: hidden;
            }

            .love-card.lgnewui-highlight::before {
                content: '';
                position: absolute;
                inset: 0;
                border-radius: inherit;
            ...
            .love-card.lgnewui-highlight::after {
                content: '';
                position: absolute;
                inset: -2px;
                border-radius: inherit;
            ...
            .love-card.lgnewui-highlight-fade {
                /* 清除态 */
            }
            ...
            .lgnewui-skeleton-screen-wrap.is-active {
                opacity: 1;
                visibility: visible;
                transform: translateY(0);
                transition-delay: 0s;
            }
            .lgnewui-skeleton-screen-anim {
            ...
            .lg-list-loading-stage {
                opacity: 0 !important;
                pointer-events: none;
            }
            /* 骨架态移除后的内容淡入 */
            .love-card:not(.lg-skeleton-card) > * {
                transition: opacity 0.3s ease, background 0.3s ease;
            }

            /* 列表淡入动画 */
            .lg-list-fade-in {
                animation: lgListFadeIn 0.4s ease-out forwards;
            }
            .lg-list-fade-in .love-card {
                animation: lgCardSlideIn 0.35s ease-out backwards;
            }
        ...
        <div class="Width_limit_10rem">
            <div class="central mar_t0">
                    ...
                    <div id="list_container">
                        ...
                        <div id="list_data">
                                                            <div class="love-card" id="event-25" data-aos="fade-up" data-aos-delay="50">
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起去爬山</span>
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起去爬山</div>
                                                <div class="info-item">
                                                ...
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                            ...
                                                            <div class="love-card" id="event-24" data-aos="fade-up" data-aos-delay="100">
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起去祈福</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起去祈福</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                            ...
                                                            <div class="love-card" id="event-23" data-aos="fade-up" data-aos-delay="150">
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起吃野人冰淇淋</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起吃野人冰淇淋</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                            ...
                                                            <div class="love-card" id="event-22" data-aos="fade-up" data-aos-delay="200">
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot com"></span>
                                            <span class="event-name">一起去散步</span>
                                            <span class="event-tags">
                                        ...
                                        <div class="body-content">
                                                ...
                                                <i class="ph-fill ph-seal-check"></i>
                                                    ...
                                                    <div class="f-carousel ConventionPhoto" view-image>
                                                                ...
                                                                <img class="lazy" draggable="false" data-src="uploads/20260727234058_6a677c0a78cee548032249_thumb.webp" data-original="http://175.178.43.207/uploads/20260727234058_6a677c0a78d0d238046096.webp" />
                                                            </div>
                                                                                                            </div>
                                                                                            </div>

                                            <div class="body-info">
                                                <div class="body-full-title">一起去散步</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                            ...
                                                            <div class="love-card" id="event-21" data-aos="fade-up" data-aos-delay="250">
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起看演唱会</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起看演唱会</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起自驾游</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起自驾游</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起放烟花</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起放烟花</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起逛宜家</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起逛宜家</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起穿情侣衣</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起穿情侣衣</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot com"></span>
                                            <span class="event-name">一起去旅行</span>
                                            <span class="event-tags">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                                ...
                                                <i class="ph-fill ph-seal-check"></i>
                                                    ...
                                                    <div class="f-carousel ConventionPhoto" view-image>
                                                                                                                    <div class="f-carousel__slide">
                                                                <img class="lazy" draggable="false" data-src="uploads/20260727225216_6a6770a0ada8d272674450_thumb.webp" data-original="http://175.178.43.207/uploads/20260727225216_6a6770a0adaa9398578630.webp" />
                                                            </div>
                                                                                                            </div>
                                                                                            </div>

                                            <div class="body-info">
                                                <div class="body-full-title">一起去旅行</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">2026-05-03</span>
                                                </div>
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                                                                        <span class="info-value lovelist-location-link has-coords" onclick="event.stopPropagation(); if(window.LGMap) LGMap.open({ mode:'events', coords:[121.491272,31.189738], zoom:15 });" data-tooltip="浦东新区"><i class="ph-fill ph-map-pin"></i><span>浦东新区</span></span>
                                                                                                    </div>
                                                                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起做饭</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起做饭</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起做美甲</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起做美甲</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起泡温泉</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起泡温泉</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起滑雪</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起滑雪</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起按摩</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起按摩</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起坐在同一个屏幕前打游戏</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起坐在同一个屏幕前打游戏</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起吃果酱烧烤</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起吃果酱烧烤</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起吃延边烧烤</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起吃延边烧烤</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                                ...
                                                <i class="ph-fill ph-seal-check"></i>
                                                    ...
                                                    <div class="f-carousel ConventionPhoto" view-image>
                                                                                                                    <div class="f-carousel__slide">
                                                                <img class="lazy" draggable="false" data-src="uploads/20260727225033_6a67703944313026122987_thumb.webp" data-original="http://175.178.43.207/uploads/20260727225033_6a67703944334125354346.webp" />
                                                            </div>
                                                                                                            </div>
                                                                                            </div>
                                            ...
                                            <div class="body-info">
                                                ...
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">2026-05-02</span>
                                                </div>
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                                                                        <span class="info-value lovelist-location-link has-coords" onclick="event.stopPropagation(); if(window.LGMap) LGMap.open({ mode:'events', coords:[121.513233,31.301767], zoom:15 });" data-tooltip="杨浦区"><i class="ph-fill ph-map-pin"></i><span>杨浦区</span></span>
                                                                                                    </div>
                                                                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起去海边</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起去海边</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起逛山姆</span>
                                            <span class="event-tags">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起逛山姆</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                                <div class="info-item">
                                                    <span class="info-label">达成地点 / LOCATION</span>
                                                        ...
                                                        <span class="info-value">哈哈哈哈哈</span>
                                                    </div>
                                                                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot air"></span>
                                            <span class="event-name">一起去电影院</span>
                                            <span class="event-tags">
                                                                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                            ...
                                            <div class="body-info">
                                                <div class="body-full-title">一起去电影院</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">---</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot com"></span>
                                            <span class="event-name">一起去吃日料</span>
                                            <span class="event-tags">
                                                <span class="etag"><i data-lucide="image" title="有照片"></i></span>                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                                ...
                                                <i class="ph-fill ph-seal-check"></i>
                                                    ...
                                                    <div class="f-carousel ConventionPhoto" view-image>
                                                                                                                    <div class="f-carousel__slide">
                                                                <img class="lazy" draggable="false" data-src="uploads/20260727225123_6a67706b33cc3255808860_thumb.webp" data-original="http://175.178.43.207/uploads/20260727225123_6a67706b33ce5935974857.webp" />
                                                            </div>
                                                                                                            </div>
                                                                                            </div>

                                            <div class="body-info">
                                                <div class="body-full-title">一起去吃日料</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">2026-05-03</span>
                                                </div>
                                    ...
                                    <div class="card-header">
                                        <div class="header-left">
                                            <span class="status-dot com"></span>
                                            <span class="event-name">一起去唱K</span>
                                            <span class="event-tags">
                                                <span class="etag"><i data-lucide="image" title="有照片"></i></span>                                                                                                                                            </span>
                                        </div>
                                        <div class="header-right">
                                    ...
                                    <div class="card-body">
                                        <div class="body-content">
                                                ...
                                                <i class="ph-fill ph-seal-check"></i>
                                                    ...
                                                    <div class="f-carousel ConventionPhoto" view-image>
                                                                                                                    <div class="f-carousel__slide">
                                                                <img class="lazy" draggable="false" data-src="uploads/20260728111441_6a681ea1820b4012757362_thumb.webp" data-original="http://175.178.43.207/uploads/20260728111441_6a681ea1820d5257482539.webp" />
                                                            </div>
                                                                                                            </div>
                                                                                            </div>

                                            <div class="body-info">
                                                <div class="body-full-title">一起去唱K</div>
                                                <div class="info-item">
                                                    <span class="info-label">完成时间 / TIME</span>
                                                    <span class="info-value">2026-05-03</span>
                                                </div>
...
<script>
    (function () {
        var requestId = "797263239ad5dc9ac76fc14d6c9aab8c";
        var token = "3ded72b2bebb9b0aafa48aef8041d1ab6b7ed75f08283cb167d5d4e5409bea22";
