...
begin:/[-+*/=%^~]|&&?|\|\|?|!=?|<(?:=>?|<|>)?|>[>=]?/,relevance:0}]}}})()
;hljs.registerLanguage("sql",e)})();/*! `less` grammar compiled for Highlight.js 11.7.0 */
(()=>{var e=(()=>{"use strict"
...
;hljs.registerLanguage("less",e)})();/*! `markdown` grammar compiled for Highlight.js 11.7.0 */
