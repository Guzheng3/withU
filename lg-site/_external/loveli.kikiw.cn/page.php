...
<head>
    <title>KKiSS小星球诞生啦！ — KKiSS小星球</title>
    <meta name="author" content="Ki">
    <meta name="love-theme" content="LGNewUI-情侣小站">
    <meta name="copyright" content="2024 LG_NewUi Web All Rights Reserved">
    <meta name="theme-color" content="#ffffff">
</head>

<body class="bg-diffuse-glow">
    <div id="pjax-container" data-view-target="article" data-view-id="1">
        <!-- PJAX 浏览量元数据 -->
        <div id="lg-view-meta" data-view-target="article" data-view-id="1" style="display:none;"></div>

        <!-- Toast -->
        <div id="toast" class="lgnewui-detail-toast">
            <i class="ph-fill ph-check-circle"></i>
            <span id="toast-msg">Success</span>
        </div>

        <!-- Right Vertical Rail (Operations) -->
        <aside class="lgnewui-detail-vertical-rail">
            <button class="lgnewui-detail-rail-btn" id="rail-like-btn" data-like-target="article" data-like-id="1" data-lg-tip="<span data-like-count='article:1'>0</span> 人喜欢" data-lg-tip-html="true" data-lg-tip-force="true" data-lg-tip-dir="left">
                <i class="ph ph-heart"></i>
            </button>
            <button class="lgnewui-detail-rail-btn lgnewui-detail-rail-mobile-only" id="mobile-toc-btn" data-lg-tip="目录" data-lg-tip-force="true" data-lg-tip-dir="left">
                <i class="ph ph-list-bullets"></i>
            </button>
            <button class="lgnewui-detail-rail-btn lgnewui-detail-rail-desktop-only" id="rail-qr-btn" data-lg-tip="<div id='qrcode-rail' style='width:100px;height:100px;margin:8px auto 0;display:flex;align-items:center;justify-content:center;'><i class='ph ph-spinner-gap' style='font-size:24px;color:rgba(255,255,255,0.5);animation:spin 1s linear infinite;'></i></div><p style='margin:10px 0 0;font-size:12px;color:rgba(255,255,255,0.7);text-align:center;'>扫码分享给好友</p>" data-lg-tip-html="true" data-lg-tip-force="true" data-lg-tip-dir="left">
                <i class="ph ph-qr-code"></i>
            </button>
            <button class="lgnewui-detail-rail-btn" id="rail-copy-btn" data-lg-tip="复制链接" data-lg-tip-force="true" data-lg-tip-dir="left">
                <i class="ph ph-link"></i>
            </button>
        </aside>

        <!-- Mobile TOC Overlay -->
        <div id="mobile-toc-overlay" class="lgnewui-detail-sheet-overlay"></div>
        <div id="mobile-toc-sheet" class="lgnewui-detail-mobile-sheet">
            <div class="lgnewui-detail-mobile-sheet-header">
                <h3 class="lgnewui-detail-mobile-sheet-title lgnewui-font-serif">目录</h3>
                <button id="mobile-toc-close" class="lgnewui-detail-mobile-sheet-close">
                    <i class="ph-bold ph-x"></i>
                </button>
            </div>
            <div class="lgnewui-toc-switcher-bar">
                <div class="lgnewui-toc-switcher-mini">
                    <button class="lgnewui-toc-tab-mini active" data-mode="none" onclick="switchTocMode('none')">
                        <i class="ph ph-minus"></i>
                        <span>默认</span>
                    </button>
                    <button class="lgnewui-toc-tab-mini" data-mode="number" onclick="switchTocMode('number')">
                        <i class="ph ph-hash"></i>
                        <span>序号</span>
                    </button>
                    <button class="lgnewui-toc-tab-mini" data-mode="tag" onclick="switchTocMode('tag')">
                        <i class="ph ph-tag"></i>
                        <span>标签</span>
                    </button>
                    <div class="lgnewui-toc-tab-indicator-mini"></div>
                </div>
            </div>
            <nav id="toc-mobile" class="lgnewui-detail-mobile-sheet-nav"></nav>
        </div>

        <!-- Main Grid -->
        <div class="lgnewui-detail-main-grid">

            <aside class="lgnewui-detail-sidebar">
                <div class="lgnewui-detail-sidebar-sticky">
                    <!-- Weather Widget -->
                                        <div class="lgnewui-detail-card lgnewui-detail-weather-widget">
                        <div class="lgnewui-detail-weather-bg-icon">
                            <i class="qi-151"></i>
                        </div>
                        <div class="lgnewui-detail-weather-content">
                            <div class="lgnewui-detail-weather-location-badge">
                                <i class="ph-fill ph-map-pin"></i>
                                <span class="lgnewui-detail-weather-location-text">吉林 · 延边朝鲜族自治州</span>
                            </div>
                            <div class="lgnewui-detail-weather-temp-row">
                                <div class="lgnewui-detail-weather-temp">18°</div>
                                <div class="lgnewui-detail-weather-condition">多云</div>
                            </div>
                            <div class="lgnewui-detail-weather-details">
                                <div class="lgnewui-detail-weather-detail-item"><i class="ph-fill ph-thermometer"></i> 体感 17°</div>
                                <div class="lgnewui-detail-weather-detail-item"><i class="ph-fill ph-drop"></i> 湿度 100%</div>
                                <div class="lgnewui-detail-weather-detail-item"><i class="ph-fill ph-wind"></i> 东北风3级</div>
                                <div class="lgnewui-detail-weather-detail-item"><i class="ph-fill ph-eye"></i> 能见度 30km</div>
                            </div>
                        </div>
                    </div>
                    
                    <!-- Sidebar TOC -->
                    <div class="lgnewui-detail-card lgnewui-detail-sidebar-toc">
                        <div class="lgnewui-toc-switcher-bar">
                            <div class="lgnewui-toc-switcher-mini">
                                <button class="lgnewui-toc-tab-mini active" data-mode="none" onclick="switchTocMode('none')">
                                    <i class="ph ph-minus"></i>
                        ...
                        <nav id="toc-desktop" class="lgnewui-detail-toc-list"></nav>
                    </div>
                </div>
            </aside>

            <!-- Main Content -->
            <main class="lgnewui-detail-main-content">

                <!-- Header Card -->
                <section class="lgnewui-detail-card lgnewui-detail-header-card">
                    <div class="lgnewui-detail-header-bg"></div>
                    <div class="lgnewui-detail-header-blob-container">
                        <div class="lgnewui-detail-header-blob lgnewui-detail-blob-left"></div>
                        <div class="lgnewui-detail-header-blob lgnewui-detail-blob-right"></div>
                    </div>
                    <div class="lgnewui-detail-header-watermark">
                        <i class="ph-duotone ph-book-open lgnewui-detail-watermark-icon"></i>
                        <span class="lgnewui-detail-watermark-text">Story</span>
                    </div>
                    <div class="lgnewui-detail-header-content lgnewui-detail-card-p-md">
                        <!-- Date Capsule -->
                        <div class="lgnewui-detail-category-wrapper">
                            <div class="lgnewui-detail-date-capsule">
                                <div class="lgnewui-detail-date-text-wrapper">
                                    <i class="ph-fill ph-sparkle lgnewui-detail-date-icon-sparkle"></i>
                                    <span>2026</span>
                                    <div class="lgnewui-detail-date-gradient-divider"></div>
                                    <span>07</span>
                                </div>
                                <div class="lgnewui-detail-date-circle">
                                    <span class="lgnewui-detail-date-day-number">27</span>
                                </div>
                            </div>
                        </div>

                        <!-- Title -->
                        <h1 class="lgnewui-detail-article-title">KKiSS小星球诞生啦！</h1>

                        <!-- Author Section -->
                        <div class="lgnewui-detail-author-section">
                            <div class="lgnewui-detail-author-row">
                                <div class="lgnewui-detail-author-info">
                                    <div class="lgnewui-detail-author-avatar-wrapper">
                                        <div class="lgnewui-detail-author-avatar-blur"></div>
                                        <img src="http://175.178.43.207/uploads/20260727162009_6a6714b9aebf7108096927.webp" class="lgnewui-detail-author-avatar">
                                        <div class="lgnewui-detail-author-badge">
                                            <i class="ph-fill ph-seal-check"></i>
                                        </div>
                                    </div>
                                    <div class="lgnewui-detail-author-text">
                                        <h3 class="lgnewui-detail-author-name">Kasenn</h3>
                                        <p class="lgnewui-detail-author-desc">
                                            <span>23:45于吉林 · 延边朝鲜族自治州，记录当下的瞬间。</span>
                                        </p>
                                    </div>
                                </div>

                                <!-- Day Stamp -->
                                <div class="lgnewui-detail-day-stamp">
                                    <span class="lgnewui-detail-day-label">WITH YOU</span>
                                    <div class="lgnewui-detail-day-value">
                            ...
                            <!-- Metadata Row -->
                            <div class="lgnewui-detail-metadata-row">
                                <!-- Views -->
                                <div class="lgnewui-detail-meta-badge">
                                    <div class="lgnewui-detail-meta-icon-wrapper">
                                        <i class="ph-fill ph-eye"></i>
                                    </div>
                                    <span class="lgnewui-detail-meta-text"><span data-view-count="article:1">0</span> 次阅读</span>
                                </div>
                                <!-- Likes -->
                                <div class="lgnewui-detail-meta-badge" data-like-target="article" data-like-id="1" style="cursor:pointer;">
                                    <div class="lgnewui-detail-meta-icon-wrapper">
                                        <i class="ph-fill ph-heart"></i>
                                    </div>
                                    <span class="lgnewui-detail-meta-text"><span class="lg-interaction-like-num" data-like-count="article:1">0</span> 喜欢</span>
                                </div>
                                <!-- Time -->
                                <div class="lgnewui-detail-meta-badge">
                                    <div class="lgnewui-detail-meta-icon-wrapper">
                                    ...
                                    <span class="lgnewui-detail-meta-text">23:45</span>
                                </div>
                                <!-- Location -->
                                <div class="lgnewui-detail-meta-badge">
                                    <div class="lgnewui-detail-meta-icon-wrapper">
                                    ...
                                    <span class="lgnewui-detail-meta-text">吉林 · 延边朝鲜族自治州</span>
                                </div>
                                ...
                                <div class="lgnewui-detail-meta-badge">
                                    ...
                                    <span class="lgnewui-detail-meta-text">庆祝</span>
                                </div>
                                                                <!-- Words -->
                                <div class="lgnewui-detail-meta-badge">
                                    <div class="lgnewui-detail-meta-icon-wrapper">
                                    ...
                                    <span class="lgnewui-detail-meta-text">80 字</span>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <!-- Main Content Card -->
                <article class="lgnewui-detail-card lgnewui-detail-article-card lgnewui-detail-card-p-md">


                    
                    <div class="lgnewui-article-body lgnewui-main" id="article-content">

                        <div class="lgnewui-detail-quote-icon">
                            <i class="ph-fill ph-quotes"></i>
                        </div>

                        <!-- Font Switcher Bar -->
                        <div class="lgnewui-detail-font-switcher-bar">
                            <div class="lgnewui-detail-font-switcher-bar-inner">
                                <div class="lgnewui-font-switcher-mini">
                                    <button class="lgnewui-font-tab-mini active" data-font="default" onclick="switchFont('default')">
                                        <i class="ph ph-text-aa"></i>
                                        <span>默认</span>
                                    </button>
                                    <button class="lgnewui-font-tab-mini" data-font="noto" onclick="switchFont('noto')">
                                        <i class="ph ph-text-t"></i>
                                        <span>宋体</span>
                                    </button>
                                    <button class="lgnewui-font-tab-mini" data-font="harmony" onclick="switchFont('harmony')">
                                        <i class="ph ph-translate"></i>
                                        <span>鸿蒙</span>
                                    </button>
                                    <div class="lgnewui-font-tab-indicator-mini"></div>
                                </div>
                            </div>
                        </div>

                        <!-- Reading Guide -->
                        <div class="lgnewui-detail-reading-guide">
                            <div class="lgnewui-detail-reading-guide-inner">
                                <div class="lgnewui-detail-reading-guide-left">
                                    <div class="lgnewui-detail-reading-guide-icon">
                                        <i class="ph-fill ph-eyeglasses"></i>
                                    </div>
                                    <span class="lgnewui-detail-reading-guide-title">阅读指引</span>
                                </div>
                                <div class="lgnewui-detail-reading-guide-spacer"></div>
                                <div class="lgnewui-detail-reading-guide-right">
                                    <div class="lgnewui-detail-reading-guide-time">
                                        <span class="lgnewui-detail-reading-guide-time-value">1</span>
                                        <span class="lgnewui-detail-reading-guide-time-label">分钟</span>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <!-- Article Content -->
                        <div id="lgnewui-detail-content" class="lgnewui-detail-text">
                            <p>从今天开始，Kasenn和Soyuet的情侣小站正式运作啦。</p>
<p>虽然我不是一个擅长写日记的人，但遇到了一个让我想要记录的人。</p>
<p>希望我们未来能好好经营小站，恋爱也一样！</p>
<p>&nbsp;</p>                        </div>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            var tabWrap = document.querySelector('.lgnewui-mobile-nav-root');
            if (tabWrap) tabWrap.style.display = 'none';
        });

    </script>

    <script src="/assets/js/page-articles.js?wm=4c668768&v=1.0.16"></script>
...
<script>
    (function () {
        var requestId = "c7a497ea3c223f42a6c396a506b2c32b";
        var token = "b41a81741193a0c1a4886ebbb91a1cd73bde5905a5f3fcea2f9c23b56049f7dd";
