...
<head>
    <title>关于 — LG-NewUi Demo</title>
</head>

<body class="bg-pdot-vignette">
    <div id="pjax-container">
        <!-- 聊天页专用样式 -->
        <link rel="stylesheet" href="/Style/css/lg-chat.css">
    ...
    <script>
        ...
        window.LG_CONFIG.anonymousAvatar = "/Lovefolder/20250310095643_67ce46dbe293d.webp";
    </script>
