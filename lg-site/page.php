...
<head>
    <title>点点滴滴语法书写参考 — LG-NewUi Demo</title>
...
<body class="bg-pdot-vignette">
    <div id="pjax-container" data-view-target="article" data-view-id="6">
        <!-- PJAX 浏览量元数据 -->
        <div id="lg-view-meta" data-view-target="article" data-view-id="6" style="display:none;"></div>
        ...
        <aside class="lgnewui-detail-vertical-rail">
            <button class="lgnewui-detail-rail-btn" id="rail-like-btn" data-like-target="article" data-like-id="6" data-lg-tip="<span data-like-count='article:6'>0</span> 人喜欢" data-lg-tip-html="true" data-lg-tip-force="true" data-lg-tip-dir="left">
                        ...
                        <div class="lgnewui-detail-category-wrapper">
                            <div class="lgnewui-detail-date-capsule">
                                ...
                                <div class="lgnewui-detail-date-circle">
                                    <span class="lgnewui-detail-date-day-number">31</span>
                                </div>
                            </div>
                        </div>

                        <!-- Title -->
                        <h1 class="lgnewui-detail-article-title">点点滴滴语法书写参考</h1>
                        ...
                        <div class="lgnewui-detail-author-section">
                            <div class="lgnewui-detail-author-row">
                                <div class="lgnewui-detail-author-info">
                                    <div class="lgnewui-detail-author-avatar-wrapper">
                                        ...
                                        <img src="/Lovefolder/20260411043037_69d95ded97293201118237.webp" class="lgnewui-detail-author-avatar">
                                        <div class="lgnewui-detail-author-badge">
                                            <i class="ph-fill ph-seal-check"></i>
                                        </div>
                                    </div>
                                    <div class="lgnewui-detail-author-text">
                                        <h3 class="lgnewui-detail-author-name">Ki.</h3>
                                        <p class="lgnewui-detail-author-desc">
                                            <span>16:51于<a href="javascript:void(0)" style="color:inherit;" onclick="if(window.LGMap) LGMap.open({ mode:'moments', coords:[114.4168,23.1115], zoom:15 })">广东·惠州</a>，记录当下的瞬间。</span>
                                        </p>
                                    </div>
                                </div>
                            ...
                            <div class="lgnewui-detail-metadata-row">
                                ...
                                <div class="lgnewui-detail-meta-badge">
                                    ...
                                    <span class="lgnewui-detail-meta-text"><span data-view-count="article:6">0</span> 次阅读</span>
                                </div>
                                <!-- Likes -->
                                <div class="lgnewui-detail-meta-badge" data-like-target="article" data-like-id="6" style="cursor:pointer;">
                                    <div class="lgnewui-detail-meta-icon-wrapper">
                                        <i class="ph-fill ph-heart"></i>
                                    </div>
                                    <span class="lgnewui-detail-meta-text"><span class="lg-interaction-like-num" data-like-count="article:6">0</span> 喜欢</span>
                                </div>
                                <!-- Time -->
                                <div class="lgnewui-detail-meta-badge">
                                    <div class="lgnewui-detail-meta-icon-wrapper">
                                    ...
                                    <span class="lgnewui-detail-meta-text">16:51</span>
                                </div>
                                <!-- Location -->
                                <div class="lgnewui-detail-meta-badge" style="cursor:pointer" onclick="if(window.LGMap) LGMap.open({ mode:'moments', coords:[114.4168,23.1115], zoom:15 })">
                                    <div class="lgnewui-detail-meta-icon-wrapper">
                                        <i class="ph-fill ph-map-pin"></i>
                                    </div>
                                    <span class="lgnewui-detail-meta-text">广东·惠州</span>
                                </div>
                                ...
                                <div class="lgnewui-detail-meta-badge">
                                    ...
                                    <span class="lgnewui-detail-meta-text">869 字</span>
                                </div>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="lgnewui-detail-reading-guide-inner">
                                ...
                                <div class="lgnewui-detail-reading-guide-right">
                                    <div class="lgnewui-detail-reading-guide-time">
                                        <span class="lgnewui-detail-reading-guide-time-value">3</span>
...
<video id="LGNewUiPlayerVideo"  controls><source src="https://classpic.kikiw.cn/video/fengjing.mp4" type="video/mp4"/></video>
...
<h6>2024-05-16 14:57:24 星期四</h6>
                                            ...
                                            <div class="lgnewui-detail-bottom-nav">
                            <div class="lgnewui-detail-bottom-nav-grid">
                                                                    <!-- Previous Article -->
                                    <a href="page.php?id=5" class="lgnewui-detail-nav-card">
                                        <div class="lgnewui-detail-nav-header">
                                            <i class="ph-bold ph-arrow-left"></i>
                                            <span>上一篇</span>
                                        </div>
                                        <div class="lgnewui-detail-nav-title">小本本</div>
                                        <div class="lgnewui-detail-nav-footer">
                                            ...
                                            <span>03月12日</span>
                                                                    ...
                                                                    <!-- Next Article -->
                                    <a href="page.php?id=7" class="lgnewui-detail-nav-card lgnewui-detail-nav-card-right">
                                        <div class="lgnewui-detail-nav-header">
                                            <span>下一篇</span>
                                            <i class="ph-bold ph-arrow-right"></i>
                                        </div>
                                        <div class="lgnewui-detail-nav-title">标签书写演示🎄🍰🐍</div>
                                        <div class="lgnewui-detail-nav-footer">
    ...
    <script>
        ...
        window.LG_CONFIG.anonymousAvatar = "/Lovefolder/20250310095445_67ce46659778a.gif";
    </script>
