...
<head>
    ...
    <link rel="stylesheet" href="/assets/css/auth.css?v=withu-logo-20260718">
    ...
    <div class="auth-container">
        <div class="auth-box glass-card">
            <div class="auth-header">
                <h1><img class="auth-logo-image" src="/assets/images/withu-logo.png" alt="<?php echo e(SITE_NAME); ?>"></h1>
